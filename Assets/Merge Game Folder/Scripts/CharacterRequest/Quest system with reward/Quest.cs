...
public class Quest : ScriptableObject
{
    ...
    public struct Info
    {
        public string Name;           // Character name (e.g., "Mama Gold", "Jigga")
        public Sprite Icon;          // Character portrait
        public Sprite CharacterIcon; // Full character portrait for requests
